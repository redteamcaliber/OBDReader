/*
    ...
    Description: The Bluetooth class interfaces with
                 the Bluetooth API to enable Bluetooth
                 capabilities for the OBDReader app.
*/
...
// The Bluetooth class will interface with the Bluetooth
// API to allow the user to connect to their Bluetooth
// OBD II dongle.
