/*
    ...
    Description: The BluetoothArrayAdapter class
                 will create a custom adapter used
...
// The BluetoothArrayAdapter is a custom adapter used for
// displaying the discovered Bluetooth devices.
public class BluetoothArrayAdapter extends ArrayAdapter<String> {

    // The ViewHolder class is used by the
    // BluetoothArrayAdapter to update the
    // list view, (lightweight inner class).
