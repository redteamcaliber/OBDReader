/*
    ...
    Description: The main activity of the OBDReader
                 app is the starting point of the app.
                 It is the interface that the user will
                 use to perform certain actions.
*/
...
// The main activity will create a UI for the user
// to navigate through the various different aspects
// of the app.
public class MainActivity extends ActionBarActivity {

    // The UI of the app used to interface
    // with the different aspects of the app.
    private UI mUI;

    // A text view that displays the
    // fault codes of the car.
    public static TextView carStatus;

    // A text view that displays the
    // status of the OBD connection.
    public static TextView connectionStatus;

    // Initializes the main activity by overriding
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Cloud debugging with Splunk Mint.
        Mint.initAndStartSession(this, "c80f7e9f");
    }

    // Populates the action items into the toolbar
